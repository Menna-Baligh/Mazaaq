                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Master Chefs</h5>
                                <p>Our culinary masters craft each dish with passion, creativity, and world-class expertise to delight every palate</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Quality Food</h5>
                                <p>We use only the freshest ingredients to serve meals that are flavorful, nutritious, and made with care</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Online Order</h5>
                                <p>With just a few clicks, enjoy your favorite meals delivered fast and fresh straight to your doorstep.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>24/7 Service</h5>
                                <p>Cravings don’t wait—neither do we. Our team is ready to serve you anytime, day or night.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <h1 class="mb-4">Welcome to <i class="fa fa-utensils text-primary me-2"></i>Mazzaq</h1>
                        <p class="mb-4">At Mazaaq, we empower restaurants with smart tools to streamline operations, boost efficiency, and deliver unforgettable dining experiences.From kitchen to customer, we're redefining how restaurants run.</p>
                        <p class="mb-4">Mazaaq puts everything at your fingertips. From ordering to payment, we've got you covered.</p>
            ...
            <div class="container">
                ...
                <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.1s">
                    <ul class="nav nav-pills d-inline-flex justify-content-center border-bottom mb-5">
                        ...
                        <li class="nav-item">
                            <a class="d-flex align-items-center text-start mx-3 me-0 pb-3" data-bs-toggle="pill" href="#tab-3" style="text-decoration: none;">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="w-100 d-flex flex-column text-start ps-4">
                                                ...
                                                <a type="button" href="{{ route('foods.show',$food->id) }}" class="btn btn-primary py-2 top-0 end-0 mt-2 me-2">Read More</a>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
